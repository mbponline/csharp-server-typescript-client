...
namespace Server.Models.Utils.DAL.Common
{
	...
	internal static class ReadUtils
	{
		...
		internal static ResultSerialData FetchMany(string entityTypeName, IEnumerable<Dto> dtos, string[] expand, Metadata metadata, Dialect dialect, string connectionString)
		{
			var keyNames = metadata.EntityTypes[entityTypeName].Key;
			var queryObject = new QueryObject()
			{
