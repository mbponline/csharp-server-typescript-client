...
namespace Server.Models.Utils.DAL.Common
{
    ...
    {
        internal static int Count(string entityTypeName, QueryObject queryObject, MetadataSrv.Metadata metadataSrv, Dialect dialect, string connectionString)
        {
        ...
        internal static ResultSerialData FetchOne(string entityTypeName, Dto dto, string[] expand, MetadataSrv.Metadata metadataSrv, Dialect dialect, string connectionString)
        {
            ...
            return Fetch(entityTypeName, queryObject, metadataSrv, dialect, connectionString);
        }

        internal static ResultSerialData FetchMany(string entityTypeName, IEnumerable<Dto> dtos, string[] expand, MetadataSrv.Metadata metadataSrv, Dialect dialect, string connectionString)
        {
            var keyNames = metadataSrv.EntityTypes[entityTypeName].Key;
            var queryObject = new QueryObject()
            {
            ...
            return ReadUtils.Fetch(entityTypeName, queryObject, metadataSrv, dialect, connectionString);
        }

        internal static ResultSerialData Fetch(string entityTypeName, QueryObject queryObject, MetadataSrv.Metadata metadataSrv, Dialect dialect, string connectionString)
        {
            var queries = GetQueryResult(entityTypeName, queryObject, metadataSrv, dialect);
